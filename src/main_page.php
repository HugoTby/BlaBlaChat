    ...
    <main class="container">
        <aside class="servers">
            ...
            <div class="servers-collection">
                <div class="server focusable unread" role="button" aria-label="Discord Developers unread">
                    <div class="server-icon"><img src="https://media.licdn.com/dms/image/C4D03AQFe17hcSre8jw/profile-displayphoto-shrink_800_800/0/1629472375644?e=2147483647&v=beta&t=GO_Of8CSmw30DXYWD7KtZNIXv6gGVhAl6kFsyjFnDKc" />
                    </div>
                </div>
            </div>
        ...
        <div class="vert-container" >
            ...
            if (isset($_POST['envoiMess']) and strlen($_POST_["contenuMess"] == 0)) {
                $requeteMess = "INSERT INTO `message` (`date`, `contenu`, `idServer`, `idUser`) VALUES ('" . date('Y-m-d H:i:s') . "', '" . $_POST['contenuMess'] . "', 1, '" . $idSession . "')";
